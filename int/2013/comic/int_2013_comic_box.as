...
{	
	...
	public class int_2013_comic_box extends MovieClip 
	{
		
		public function int_2013_comic_box(Z:*) 
		{
			...
			Z.hat.magicast_render = function() {
				...
				if (data != oldData) 
				{
					...
					points.push(new Point(c.width, 0));
					points.push(new Point(c.width, c.height));
					points.push(new Point(0, c.height));
					points.push(new Point(0, 0));

					s.graphics.clear();
					Z.comic.drawLine(s, points, comicLineFormat, 0, phase);
